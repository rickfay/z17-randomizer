use {
    crate::hints::hint_color::HintColor::*,
    jack::item::{Item, Item::*},
...
impl FillerItem {
    pub fn is_dungeon_prize(&self) -> bool {
        match self {
            PendantOfPower
            | PendantOfWisdom
            | PendantOfCourage01
...
fn item_to_str(item: &Item) -> &'static str {
    match item {
        ...
        Item::SageGulley => "Sage Gulley",
        Item::SageOren => "Sage Oren",
        Item::SageSeres => "Sage Seres",
        Item::SageOsfala => "Sage Osfala",
        Item::SageImpa => "Sage Impa",
        Item::SageIrene => "Sage Irene",
        Item::SageRosso => "Sage Rosso",
