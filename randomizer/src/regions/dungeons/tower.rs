crate::region! {
    ...
    hera {
        ...
        paths: [
            floor2 :- {|p| p.can_merge() || (p.glitched() && (p.sword() && p.can_bomb()))},
        ],
    },
    floor2 {
        locations: [
        ...
        paths: [
            floor4 :- {|p| p.small_keys(COURSE) > 0 || (p.glitched() && (p.can_bomb() && p.can_tornado_rod()))},
        ],
    },
    floor4 {
        locations: [
        ...
        paths: [
            floor7 :- {|p| p.small_keys(COURSE) > 1 || (p.glitched() && (p.can_bomb() && p.can_tornado_rod()))},
        ],
    },
    floor7 {
        locations: [
