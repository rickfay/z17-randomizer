use {
    ...
    seed::{
        filler::{
            ...
            logic::Logic,
            progress::Progress,
            regions::{self, Location},
        },
        WorldGraph,
    },
    std::collections::{HashMap, HashSet},
};
use seed::world::check::{Check, CheckId::*};
...
fn hyrule() -> HashSet<Location> {
    ...
    //                     Some(|p| {
    //                         if p.is_rse() { p.has_sage_irene() } else { p.has_pendant_of_courage() }
    //                     }),
    //                     None,
    //                     None,
    //                     None,
    ...
    //                     RossoHouse,
    //                     Some(|p| {
    //                         if p.is_rse() { p.has_sage_rosso() } else { p.has_pendant_of_courage() }
    //                     }),
    //                     None,
    //                     None,
    //                     None,
    ...
    //     (
    //         EasternRuinsEastLedge,
    //         location("Eastern Ruins East Ledge", vec![ghost(HintGhostEasternRuinsCave)], vec![
    //             fast_travel_hyrule(),
    ...
    //         location("Death Mountain West Top", vec![ghost(HintGhostTowerOfHeraOutside)], vec![
    //             fast_travel_hyrule(),
    //             path_free(SpectacleRockCaveRight),
    ...
    //                     LocationInfo::new(
    //                         regions::hyrule::death::mountain::SUBREGION,
    //                         "[Mai] Outside Death Mountain Treasure Dungeon",
    //                     ),
    //                     Some(|p| p.can_merge()),
    //                     None,
    //                     None,
...
// /// Lorule
// fn lorule() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             LoruleBellTravel,
...
//         (
//             VeteranThiefsHouse,
//             location("Veteran Thief's House", vec![ghost(HintGhostVeteranThief)], vec![path_free(
//                 LoruleCastleField,
//             )]),
//         ),
//         (
//             FortunesChoiceLorule,
//             location("Fortune's Choice (Lorule)", vec![ghost(HintGhostFortunesChoice)], vec![
//                 path_free(LoruleCastleField),
//             ]),
//         ),
//         (
...
//         (
//             DesertCenterLedge,
//             location("Desert Center Ledge", vec![ghost(HintGhostDesertCenter)], vec![
//                 path_free(Desert),
...
//         (
//             DesertSouthWestLedge,
//             location("Desert South West Ledge", vec![ghost(HintGhostDesertSouthWest)], vec![
//                 fast_travel_hyrule(),
//                 path_free(Desert),
//                 portal_std(MiseryMireBridge),
...
//         (
//             TurtleRockWeatherVane,
//             location("Turtle Rock Weather Vane", vec![ghost(HintGhostTurtleRockOutside)], vec![
//                 fast_travel_lorule(),
//                 path(
//                     TurtleRockFrontDoor,
...
//         (
//             DarkPalaceWeatherVane,
//             location("Dark Ruins Weather Vane", vec![ghost(HintGhostDarkPalaceOutside)], vec![
//                 path(
//                     DarkMazeEntrance,
//                     Some(|p| p.can_merge() || p.has_sage_gulley()),
//                     None,
...
//                         LocationInfo::new(
//                             regions::lorule::death::mountain::SUBREGION,
//                             "Lorule Death Mountain West Ledge",
//                         ),
//                         Some(|p| p.can_merge()),
//                         None,
...
//                     LocationInfo::new(
//                         regions::lorule::death::mountain::SUBREGION,
//                         "Lorule Death Mountain East Ledge",
//                     ),
//                     Some(|p| p.can_merge()),
//                     None,
//                     None,
...
//
// /// Eastern Palace
// fn eastern_palace() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             EasternPalaceFoyer,
//             location(
...
//
// /// House of Gales
// fn house_of_gales() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             HouseOfGalesFoyer,
...
//
// /// Tower of Hera
// fn tower_of_hera() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             TowerOfHeraFoyer,
...
// fn inside_hyrule_castle() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             HyruleCastleDungeon,
...
//
// /// Dark Palace
// fn dark_palace() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             DarkPalaceFoyer,
...
//
// /// Swamp Palace
// fn swamp_palace() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             SwampPalaceOutside,
...
//
// /// Skull Woods
// fn skull_woods() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             SkullWoodsFoyer,
...
//
// /// Thieves' Hideout
// fn thieves_hideout() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             ThievesHideoutB1,
//             location(
...
//
// /// Ice Ruins
// fn ice_ruins() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             IceRuinsFoyer,
...
//
// /// Desert Palace
// fn desert_palace() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             DesertPalaceFoyer,
//             location(
...
//
// /// Turtle Rock
// fn turtle_rock() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             TurtleRockFoyer,
...
//
// /// Lorule Castle
// fn lorule_castle() -> HashMap<LocationId, LocationNode> {
//     HashMap::from([
//         (
//             LoruleCastle1F,
...
fn portal(destination: LocationId, logic: Logic) -> Path {
    Path::new(destination, logic)
}

fn fast_travel_hyrule() -> Path {
    Path::new(HyruleBellTravel, *Logic::new().normal(|p| p.are_vanes_activated() && p.has_bell()))
}

fn fast_travel_lorule() -> Path {
    Path::new(LoruleBellTravel, *Logic::new().normal(|p| p.are_vanes_activated() && p.has_bell()))
}
