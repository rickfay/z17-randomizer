            ...
            location(
                ...
                vec![
                    ...
                    edge!(DarkRuins => {
                        ...
                        hell: |p| p.has_flippers() || p.has_hookshot(), // Bee Boost
                    }),
                    edge!(GraveyardLedgeLorule, |p| p.has_bombs()),
                ],
            ),
        ),
        (
        ...
        (
            ...
            location(
                ...
                vec![
                    ...
                    check!("Ice Gimos Fight", regions::lorule::death::mountain::SUBREGION, |p| p.can_attack_iceproof()),
