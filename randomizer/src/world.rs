...
fn hyrule() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (ChamberOfSages, location("Chamber of Sages", vec![
            check(LocationInfo::new(regions::lorule::chamber::sages::SUBREGION, "Osfala"),
                  Some(|p| p.has_sage_osfala()),
                  None,
                  None,
                  None,
        ...
        (HyruleField, location("Hyrule Field", vec![
            check_free(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "Dampe")),
            check(LocationInfo::new(regions::hyrule::irene::witch::SUBREGION, "Irene"),
                  Some(|p| if p.is_rse() { p.has_sage_irene() } else { p.has_pendant_of_courage() }),
                  None,
                  None,
                  None,
                  None,
            ),
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "Sanctuary Pegs"),
                  Some(|p| p.has_hammer()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Hyrule Castle Rocks"),
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Wildlife Clearing Stump"),
            ...
            check(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "Southeastern Shore"),
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Hyrule Hotfoot (First Race)"),
                  Some(|p| p.has_boots()),
                  Some(|_| true),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Hyrule Hotfoot (Second Race)"),
                  Some(|p| p.has_boots()),
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "Bird Lover"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
            ...
            // Kakariko Village
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Street Merchant (Left)")),
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Street Merchant (Right)"),
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Shady Guy"),
            ...
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Dodge the Cuccos")),
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Rupee Rush (Hyrule)")),
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "[Mai] Kakariko Bush")),
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Lost Woods Path Rock"),
                  Some(|p| p.has_titans_mitt() || (p.has_power_glove() && p.has_hammer())),
                  None,
                  Some(|p| { p.has_power_glove() && (p.has_hookshot() || (p.has_boomerang() && p.can_escape())) }),
                  None,
                  None,
            ),
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Fortune-Teller Tent"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "[Mai] Woman's Roof Rock"),
                  Some(|p| p.has_power_glove()),
                  None,
                  None,
                  None,
            ...
            check_quest("Woman Roof Maiamai", WomanRoofMaiamai,
                        Some(|p| p.has_power_glove()),
                        None,
                        None,
                        None,
            ...
            // Eastern Ruins
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "Eastern Ruins Peg Circle"),
                  Some(|p| p.has_hammer()),
                  None,
            ...
            // Maiamai
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Rosso Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Small Pond"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "[Mai] Sanctuary Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Tree Behind Blacksmith"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Lost Woods Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Hyrule Castle Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Hyrule Castle Tornado Tile"),
                  Some(|p| p.has_tornado_rod()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "[Mai] Under Wooden Bridge"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "[Mai] Eastern Ruins Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "[Mai] Eastern Ruins Yellow Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "[Mai] Eastern Ruins Green Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "[Mai] Eastern Ruins Big Rock"),
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Blacksmith Tornado Tile"),
                  Some(|p| p.has_tornado_rod()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "[Mai] Atop Eastern Rocks"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "[Mai] Hyrule Rupee Rush Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "[Mai] Cucco Ranch Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Wildlife Clearing Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            path(RossoHouse,
                 Some(|p| if p.is_rse() { p.has_sage_rosso() } else { p.has_pendant_of_courage() }),
                 None,
                 None,
                 None,
                 None,
            ...
            path(WaterfallLedge,
                 ...
                 None,
                 None,
                 Some(|p| { p.can_merge() && p.has_boots() && (p.has_fire_rod() || p.has_nice_bombs()) }),
                 Some(|p| p.can_merge() && p.has_boots()),
            ),
            path_free(CuccoHouse),
            path_free(WomanHouse),
            path(StylishWomanHouse,
        ...
        (MaiamaiCave, location("Mother Maiamai Cave", vec![
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 10 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 20 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 30 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 40 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 50 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 60 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 70 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 80 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, " 90 Maiamai")),
            check_unreachable(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "100 Maiamai")),
        ], vec![
            path_free(HyruleField)
        ])),
        (WomanHouse, location("Woman's House", vec![
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Woman"),
        ...
        (CuccoHouse, location("Cucco House", vec![], vec![
            path_free(HyruleField),
            path_free(CuccoHouseRear),
        ])),
        (CuccoHouseRear, location("Cucco House Rear", vec![
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "[Mai] Kakariko Sand"),
                  Some(|p| p.has_sand_rod()),
                  None,
                  None,
                  None,
        ...
        (WaterfallLedge, location("Waterfall Ledge", vec![
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "[Mai] Waterfall Ledge Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (CuccoDungeonLedge, location("Cucco Dungeon Ledge", vec![
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "[Mai] Cucco Treasure Dungeon Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
        ...
        (CuccoDungeon, location("Cucco Treasure Dungeon", vec![
        ...
        (WitchHouse, location("Witch's House", vec![
            ...
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "[Mai] Inside Witch's House"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (ZoraDomainArea, location("Zora's Domain Area", vec![
            check_quest("Shady Guy Trigger", ShadyGuyTrigger,
            ...
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "Zora's Domain Ledge"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "[Mai] Zora's Domain Water"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "[Mai] Zora's Domain South Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (WaterfallCave, location("Waterfall Cave", vec![
            check_free(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "Waterfall Cave"))
        ], vec![
            path_free(WaterfallCaveShallowWater)
        ])),
        (MergeDungeon, location("Eastern Ruins Treasure Dungeon", vec![
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "Eastern Ruins Treasure Dungeon"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (EastRuinsBombCaveUpper, location("Eastern Ruins Bomb Cave Upper", vec![
            check(LocationInfo::new(regions::hyrule::eastern::ruins::SUBREGION, "Eastern Ruins Cave"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (HouseOfGalesIsland, location("House of Gales Island", vec![
            check(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "[Mai] Island Tornado Tile"),
                  Some(|p| p.has_tornado_rod()),
                  None,
                  None,
                  None,
        ...
        (RossoHouse, location("Rosso's House", vec![
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Rosso"),
                  Some(|p| if p.is_rse() { p.has_sage_rosso() } else { p.has_pendant_of_courage() }),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Rosso Rocks"),
                  Some(|p| p.has_power_glove() && if p.is_rse() { p.has_sage_rosso() } else { p.has_pendant_of_courage() }),
                  None,
                  None,
                  None,
                  None,
        ...
        (RossoCave, location("Rosso Cave", vec![
            check_free(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Rosso Cave"))
        ], vec![
            path_free(HyruleField)
        ])),
        (TornadoRodDungeon, location("Zora's River Treasure Dungeon", vec![
            check(LocationInfo::new(regions::hyrule::zora::river::SUBREGION, "Zora's River Treasure Dungeon"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (GraveyardLedgeHyrule, location("Graveyard Ledge", vec![
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "[Mai] Hyrule Graveyard Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (GraveyardLedgeCave, location("Graveyard Ledge Cave", vec![
            check_free(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "Graveyard Ledge Cave",
            ))
        ], vec![
        ...
        (HyruleCastleLeftRoom, location("Hyrule Castle Left Room", vec![
            check_free(LocationInfo::new(regions::dungeons::hyrule::castle::SUBREGION, "[HC] West Wing"))
        ], vec![
            path_free(HyruleCastleCourtyard)
        ])),
        (HyruleCastleRoof, location("Hyrule Castle Roof", vec![
            check_free(LocationInfo::new(regions::dungeons::hyrule::castle::SUBREGION, "[HC] Battlement"))
        ], vec![
            fast_travel_hyrule(),
            path_free(HyruleField),
            path_free(HyruleCastleCourtyard),
        ...
        (LostWoods, location("Lost Woods", vec![
            ...
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Lost Woods Rock"),
                  Some(|p| p.has_power_glove()),
                  None,
                  None,
                  None,
        ...
        (MasterSwordArea, location("Master Sword Area", vec![
            ...
            fast_travel_hyrule(), path_free(LostWoods),
        ])),
        (FortuneTeller, location("Fortune-Teller (Hyrule)", vec![
            check_free(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "Fortune-Teller"))
        ], vec![
            path_free(HyruleField)
        ])),
        (KakarikoJailCell, location("Kakariko Jail Cell", vec![
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Kakariko Jail"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (WellUpper, location("Kakariko Well Upper", vec![
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Kakariko Well (Top)"))
        ], vec![
            path_free(WellLower)
        ])),
        (WellLower, location("Kakariko Well Lower", vec![
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Kakariko Well (Bottom)"))
        ], vec![
            path_free(HyruleField)
        ])),
        (StylishWomanHouse, location("Stylish Woman's House", vec![
            check_free(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Stylish Woman")),
        ...
        (MilkBar, location("Milk Bar", vec![
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Milk Bar Owner"),
        ...
        (BeeGuyHouse, location("Bee Guy's House", vec![
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Bee Guy (1)"),
                  Some(|p| p.has_bottle()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::village::SUBREGION, "Bee Guy (2)"),
        ...
        (SouthernRuinsBombCave, location("Southern Ruins Bomb Cave", vec![
            check(LocationInfo::new(regions::hyrule::southern::ruins::SUBREGION, "[Mai] Southern Ruins Bomb Cave"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            path_free(HyruleField), path_free(SouthernRuinsPillars),
        ])),
        (SouthernRuinsPillars, location("Southern Ruins Pillars", vec![
            check_free(LocationInfo::new(regions::hyrule::southern::ruins::SUBREGION, "Southern Ruins Pillar Cave"))
        ], vec![
            fast_travel_hyrule(),
            path_free(SouthernRuinsBombCave),
        ])),
        (LakeDarkCave, location("Lake Hylia Dark Cave", vec![
            check(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "Lake Hylia Dark Cave"),
        ...
        (IceRodCave, location("Ice Rod Cave", vec![
            check_free(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "Ice Rod Cave"))
        ...
        (Sanctuary, location("Sanctuary", vec![
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "[HS] Lower Chest"),
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "[HS] Upper Chest"),
                  Some(|p| p.has_lamp() || (p.has_fire_rod() && p.lampless())),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::hyrule::SUBREGION, "[HS] Ledge"),
            ...
            check_quest("Open Sanctuary Doors", OpenSanctuaryDoors,
                        Some(|p| { (p.has_lamp() || (p.has_fire_rod() && p.lampless())) && p.can_attack() && p.has_sanctuary_key() }),
        ...
        (MoldormLedge, location("Moldorm Ledge", vec![
            check(LocationInfo::new(regions::hyrule::lost::woods::SUBREGION, "[Mai] Moldorm Ledge"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (DeathMountainBase, location("Death Mountain Base", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "[Mai] Death Mountain West Rock"),
                  Some(|p| p.has_power_glove()),
                  None,
                  None,
                  None,
        ...
        (DeathWeatherVaneCaveLeft, location("Death Mountain Cave Left of Weather Vane", vec![
            check_free(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Death Mountain Open Cave"))
        ], vec![
            path_free(DeathMountainBase)
        ])),
        (DeathFairyCave, location("Death Mountain Fairy Cave", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Death Mountain Fairy Cave"),
        ...
        (DonkeyCaveUpper, location("Donkey Cave Upper", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Donkey Cave Pegs"),
                  Some(|p| p.has_hammer()),
                  None,
                  None,
                  None,
        ...
        (DeathSecondFloor, location("Death Mountain Second Floor", vec![], vec![
            ...
            path(DeathFairyCave,
                 None,
                 None,
                 Some(|p| { p.has_fire_rod() || p.has_nice_bombs() || p.has_boomerang() || p.has_hookshot() }),
                 None,
                 Some(|p| p.has_bombs()),
            ),
        ])),
        ...
        (AmidaCaveUpper, location("Amida Cave Upper", vec![
            check_free(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Death Mountain West Highest Cave"))
        ], vec![
            path_free(AmidaCaveLower),
            path_free(DeathThirdFloor),
        ...
        (SpectacleRock, location("Spectacle Rock", vec![
            check_free(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Spectacle Rock"))
        ], vec![
            fast_travel_hyrule(),
            path_free(DeathThirdFloor),
        ...
        (DeathMountainEastTop, location("Death Mountain East Top", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "[Mai] Outside Death Mountain Treasure Dungeon"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (HookshotDungeon, location("Death Mountain Treasure Dungeon", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Death Mountain Treasure Dungeon"),
        ...
        (FireCaveCenter, location("Fire Cave Center", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Fire Cave Pillar"),
        ...
        (BoulderingLedgeBottom, location("Bouldering Guy Bottom Ledge", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "[Mai] Death Mountain East Ledge Rock"),
                  Some(|p| p.has_power_glove()),
                  None,
                  None,
                  None,
        ...
        (BoulderingLedgeRight, location("Bouldering Guy Right Ledge", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Bouldering Guy"),
        ...
        (RossosOreMine, location("Rosso's Ore Mine", vec![
            check(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "[Mai] Rosso's Ore Mine Rock"),
                  Some(|p| p.has_power_glove()),
                  None,
                  None,
                  None,
        ...
        (FloatingIslandHyrule, location("Hyrule Floating Island", vec![
            check_free(LocationInfo::new(regions::hyrule::death::mountain::SUBREGION, "Floating Island"))
        ], vec![
            fast_travel_hyrule(),
...
fn lorule() -> HashMap<Location, LocationNode> {
    HashMap::from([
        (LoruleBellTravel, location("Lorule Bell Travel", vec![], vec![
        ...
        (LoruleCastleField, location("Lorule Castle Field", vec![
            ...
            check_free(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Fortune's Choice")),
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Castle Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Castle Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Thieves' Town Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Fortune-Teller Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Blacksmith Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Rupee Rush Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Octoball Derby Skull"),
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Vacant House Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Behind Vacant House"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Southern Ruins Pillars"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Southern Ruins Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Southern Ruins Water"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Thieves' Town Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            path(BigBombCave, Some(|p| p.has_bomb_flower()),
                 None,
                 None,
                 None,
                 None,
        ...
        (ThievesTownItemShop, location("Thieves' Town Item Shop", vec![
            ...
            check_unreachable(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Thieves' Town Item Shop (2)")),
            check_free(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Thieves' Town Item Shop (3)")),
            check_free(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Thieves' Town Item Shop (4)")),
        ], vec![
            path_free(LoruleCastleField)
        ])),
        (BigBombFlowerShop,
        ...
        (BigBombFlowerField, location("Big Bomb Flower Field", vec![
            ...
            check_free(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Big Bomb Flower Field Grass")),
        ], vec![
            fast_travel_lorule(),
            path_free(BigBombFlowerShop),
        ...
        (LoruleGraveyard, location("Lorule Graveyard", vec![
            check_free(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "Graveyard Peninsula")),
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[Mai] Lorule Graveyard Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[Mai] Lorule Graveyard Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[Mai] Lorule Graveyard Peninsula Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
        ...
        (LoruleSanctuary, location("Lorule Sanctuary", vec![
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[LS] Entrance Chest"),
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[LS] Lower Chest"),
                  Some(|p| p.has_lamp() || (p.has_fire_rod() && p.lampless())),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(
                regions::dungeons::graveyards::lorule::SUBREGION, "[LS] Upper Chest", ),
                  Some(|p| p.has_lamp() || (p.has_fire_rod() && p.lampless())),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "[LS] Ledge"),
                  Some(|p| { p.can_merge() && (p.has_lamp() || (p.has_fire_rod() && p.lampless())) }),
                  None,
                  None,
                  None,
            ...
            path(LoruleSanctuaryCaveUpper,
                 Some(|p| { (p.has_lamp() || (p.has_fire_rod() && p.lampless())) && p.can_attack() && p.has_lorule_sanctuary_key() }),
        ...
        (LoruleSanctuaryCaveUpper, location("Philosopher's Cave Upper", vec![
            check(LocationInfo::new(regions::dungeons::graveyards::lorule::SUBREGION, "Philosopher's Cave"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (BootsDungeon, location("Lorule Field Treasure Dungeon", vec![
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Lorule Field Treasure Dungeon"),
                  Some(|p| p.has_boots()),
        ...
        (BigBombCave, location("Haunted Grove Big Bomb Cave", vec![
            check_free(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Big Bomb Flower Cave"))
        ], vec![
            path_free(LoruleCastleField)
        ])),
        (HauntedGroveLedge, location("Haunted Grove Upper Ledge", vec![
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "Lorule Field Hookshot Chest"),
                  Some(|p| p.has_hookshot()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::field::main::SUBREGION, "[Mai] Lorule Haunted Grove Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        // Desert / Misery Mire
        (Desert, location("Desert", vec![
            check(LocationInfo::new(regions::hyrule::desert::mystery::SUBREGION, "[Mai] Buried in the Desert"),
                  Some(|p| p.has_sand_rod()),
                  None,
                  None,
                  None,
        ...
        (DesertPalaceWeatherVane, location("Desert Palace Weather Vane", vec![
            check(LocationInfo::new(regions::hyrule::desert::mystery::SUBREGION, "[Mai] Buried near Desert Palace"),
                  Some(|p| p.has_sand_rod()),
                  None,
                  None,
                  None,
        ...
        (MiseryMire, location("Misery Mire", vec![
            check(LocationInfo::new(regions::lorule::misery::mire::SUBREGION, "[Mai] Misery Mire Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::misery::mire::SUBREGION, "[Mai] Misery Mire Water"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::misery::mire::SUBREGION, "[Mai] Misery Mire Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
        ...
        (SandRodDungeon, location("Misery Mire Treasure Dungeon", vec![
            check(LocationInfo::new(regions::lorule::misery::mire::SUBREGION, "Misery Mire Treasure Dungeon"),
        ...
        // Lorule Lake Area
        (LoruleLakeEast, location("Lorule Lake East", vec![
            check(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "[Mai] Lorule Lake SE Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "[Mai] Lorule Lake Skull"),
        ...
        (LoruleLakeNorthWest, location("Lorule Lake North West", vec![
            check_quest("Turtle (wall)", TurtleWall,
                        Some(|p| p.can_merge()),
                        None,
                        None,
                        None,
            ...
            check_free(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "Lorule Lake Chest")),
            check(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "[Mai] Lorule Lake West Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (LoruleLakeSouthWest, location("Lorule Lake South West", vec![
            check_quest_free("Turtle (flipped)", TurtleFlipped),
            check(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "[Mai] Lorule Lake Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
        ...
        (LoruleLakesideItemShop, location("Lorule Lakeside Item Shop", vec![
            check_free(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "Lorule Lakeside Item Shop (1)")),
            check_unreachable(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "Lorule Lakeside Item Shop (2)")),
            check_free(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "Lorule Lakeside Item Shop (3)")),
            check_free(LocationInfo::new(regions::lorule::lake::lorule::SUBREGION, "Lorule Lakeside Item Shop (4)")),
        ], vec![
            path_free(LoruleLakeNorthWest)
        ])),
        // This location assumes the player is already swimming, real or fake
        (LoruleLakeWater, location("Lorule Lake Water", vec![
            check_quest("Turtle (under attack)", TurtleAttacked,
                        Some(|p| p.can_attack()),
        ...
        (TurtleRockFrontDoor, location("Turtle Rock Front Door", vec![], vec![
            fast_travel_lorule(),
        ...
        (DarkRuins, location("Dark Ruins", vec![
            ...
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Atop Dark Ruins Rocks"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Dark Ruins West Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Dark Ruins East Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Dark Ruins South Area Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            path(LoruleLakeEast,
                 None,
                 None,
                 Some(|p| { p.has_stamina_scroll() && (p.has_fire_rod() || p.has_nice_bombs()) }), // long merge
                 None,
                 Some(|p| p.has_stamina_scroll()), // Bee Boost
            ),
        ])),
        ...
        (KusDomainSouth, location("Ku's Domain South", vec![
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Ku's Domain Grass"),
        ...
        (KusDomain, location("Ku's Domain", vec![
            ...
            check(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Ku's Domain Water"),
                  Some(|p| p.has_flippers()),
                  None,
                  None,
                  None,
            ...
            fast_travel_lorule(),
            path_free(KusDomainSouth),
        ])),
        (HinoxCaveWater, location("Hinox Cave Water", vec![
            // This location assumes the player is already swimming, real or fake
            check_free(LocationInfo::new(regions::lorule::dark::ruins::SUBREGION, "[Mai] Outside Hinox Cave")),
        ], vec![
        ...
        (SkullWoodsOverworld, location("Skull Woods (Overworld)", vec![
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "Canyon House"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Grass"),
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Skull"),
                  Some(|p| p.can_destroy_skull()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Shack Tree"),
                  Some(|p| p.has_boots()),
                  None,
                  None,
                  None,
            ...
            check_free(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Bush")),
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Entrance Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Skull Woods Dry Pond"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "[Mai] Canyon House Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (MysteriousManCave, location("Mysterious Man Cave", vec![
            check(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "Mysterious Man"),
                  Some(|p| p.has_bottle()),
                  None,
                  None,
                  None,
        ...
        (LoruleDeathWest, location("Lorule Death Mountain West", vec![
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Ice Gimos Fight"),
            ...
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Lorule Death Mountain West Ledge"),
                  Some(|p| p.can_merge()),
                  None,
            ...
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Treacherous Tower Intermediate"),
                  Some(|p| { (p.has_sword() || (p.swordless_mode() && p.can_attack())) && (p.has_bombs() || p.has_hammer() || p.has_tornado_rod()) }),
                  Some(|p| { p.has_bombs() || p.has_hammer() || (p.has_tornado_rod() && p.has_lamp_or_net()) }),
                  None,
                  None,
                  None,
            ),
            check_unreachable(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Treacherous Tower Advanced (1)")),
            check_unreachable(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Treacherous Tower Advanced (2)")),
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Lorule Death Mountain West Skull"),
                  Some(|p| p.can_destroy_skull()),
                  Some(|p| p.can_merge()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Lorule Death Mountain West Big Rock"),
            ...
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Lorule Death Mountain East Big Rock"),
                  Some(|p| p.has_titans_mitt()),
                  None,
                  None,
                  None,
        ...
        (RossosOreMineLorule, location("Rosso's Ore Mine Lorule", vec![
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Lorule Death Mountain East Wall"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (LoruleDeathEastLedgeUpper, location("Lorule Death Mountain East Upper Ledge", vec![
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Lorule Death Mountain East Ledge"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (LoruleDeathEastLedgeLower, location("Lorule Death Mountain East Lower Ledge", vec![
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Lorule Death Mountain East Skull"),
                  Some(|p| p.can_destroy_skull()),
                  None,
                  None,
                  None,
        ...
        (LoruleDeathEastTop, location("Lorule Death Mountain East Top", vec![
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "Behind Ice Gimos"),
            ...
            check(LocationInfo::new(regions::lorule::death::mountain::SUBREGION, "[Mai] Outside Ice Ruins"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
...
fn tower_of_hera() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (
            TowerOfHeraBoss,
            location("Tower of Hera Boss", vec![], vec![path(
                TowerOfHeraPostBoss,
