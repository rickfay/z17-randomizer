...
fn hyrule() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (HyruleField, location("Hyrule Field", vec![
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Irene"),
            ...
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Haunted Grove Tree Stump"),
                  Some(|p| p.has_pendant_of_courage()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::kakariko::shady_guy::SUBREGION, "Merchant (Right)"),
            ...
            check_free(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Rupee Rush (Hyrule)")),
        ...
        (RossoHouse, location("Rosso's House", vec![
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Rosso"),
                  Some(|p| p.has_completed_eastern() || p.can_merge()),
                  None,
                  None,
                  None,
                  None,
            ),
            check(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Clean Rocks"),
                  Some(|p| p.has_completed_eastern() && p.has_power_glove()),
                  None,
                  None,
                  None,
                  None,
        ...
        (HyruleCastleLeftRoom, location("Hyrule Castle Left Room", vec![
            check_free(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Castle (Indoors)")),
        ], vec![
            path_free(HyruleCastleCourtyard),
        ])),
        (HyruleCastleRoof, location("Hyrule Castle Roof", vec![
            check_free(LocationInfo::new(regions::hyrule::field::main::SUBREGION, "Castle Balcony")),
        ], vec![
            fast_travel_hyrule(),
            path_free(HyruleField),
            path_free(HyruleCastleCourtyard),
...
fn lorule() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (SkullWoodsOverworld, location("Skull Woods (Overworld)", vec![
            ...
            check_free(LocationInfo::new(regions::lorule::skull::overworld::SUBREGION, "Cucco Shack")),
...
fn eastern_palace() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (EasternPalace1F, location("Eastern Palace 1F", vec![
            ...
            check(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (1F) Defeat Popos"),
                  Some(|p| p.can_attack()),
                  Some(|p| p.has_lamp_or_net()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (1F) Hidden Door"),
                  Some(|p| p.can_attack()),
                  Some(|p| p.has_lamp_or_net()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (1F) Switch Puzzle"),
                  Some(|p| p.can_hit_far_switch()),
        ...
        (EasternPalacePostYuga, location("Eastern Palace Post Yuga", vec![
            check_free(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (3F) After Cutscene")),
            check_free(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] Yuga")),
        ...
        (EasternPalaceEscape, location("Eastern Palace Escape", vec![
            check_free(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (3F) Outside (North)")),
            check_free(LocationInfo::new(regions::dungeons::eastern::palace::SUBREGION, "[EP] (1F) Outside (West)")),
        ], vec![
...
fn house_of_gales() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (HouseOfGalesBoss, location("House of Gales Boss", vec![
            check(LocationInfo::new(regions::dungeons::house::gales::SUBREGION, "[HG] Margomill"),
                  Some(|p| p.can_defeat_margomill()),
                  None,
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::house::gales::SUBREGION, "House of Gales Prize"),
                  Some(|p| p.can_defeat_margomill()),
                  None,
                  None,
                  None,
...
fn tower_of_hera() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (TowerOfHeraBottom, location("Tower of Hera Bottom", vec![
            check(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (1F) Outside"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (1F) Center"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (3F) Platform"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  Some(|p| p.has_sword() && p.has_bombs()),
        ...
        (TowerOfHeraMiddle, location("Tower of Hera Middle", vec![
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (5F) Red/Blue Switches")),
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (6F) Right Mole")),
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (6F) Left Mole")),
        ], vec![
        ...
        (TowerOfHeraTop, location("Tower of Hera Top", vec![
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (7F) Outside (Ledge)")),
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (8F) Fairy Room")),
            check_free(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] (11F) Big Chest")),
        ], vec![
        ...
        (TowerOfHeraBoss, location("Tower of Hera Boss", vec![
            check(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "[TH] Moldorm"),
            ...
            check(LocationInfo::new(regions::dungeons::tower::hera::SUBREGION, "Tower of Hera Prize"),
                  Some(|p| p.can_defeat_moldorm()),
                  None,
                  None,
                  None,
...
fn dark_palace() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (DarkPalaceSecondRoom, location("Dark Palace Second Room", vec![
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Near Entrance")),
            check(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Narrow Ledge"),
                  Some(|p| p.can_merge() || p.has_boomerang() || p.has_hookshot()),
                  None,
                  None,
                  None,
        ...
        (DarkPalaceMain, location("Dark Palace", vec![
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Switch Puzzle")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Hidden Room (Upper)")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Hidden Room (Lower)")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (B1) Fall From 1F")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (B1) Helmasaur Room")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (B1) Helmasaur Room (Fall)")),
            check(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (B1) Maze"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
        ...
        (DarkPalaceLockedDoors, location("Dark Palace Locked Doors", vec![
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (1F) Fall From 2F")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (2F) Big Chest (Hidden)")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (2F) South Hidden Room")),
            check(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (2F) Alcove"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
                  None,
            ...
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] (B1) Big Chest (Switches)")),
        ], vec![
        ...
        (DarkPalaceBoss, location("Dark Palace Boss", vec![], vec![
            path(DarkPalaceAfterBoss,
        ...
        (DarkPalaceAfterBoss, location("Dark Palace After Boss", vec![
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] Gemesaur King")),
            check_free(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "Dark Palace Prize")),
...
fn swamp_palace() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (SwampPalaceMain, location("Swamp Palace", vec![
            ...
            check(LocationInfo::new(regions::dungeons::swamp::palace::SUBREGION, "[SP] Arrghus"),
            ...
            check(LocationInfo::new(regions::dungeons::swamp::palace::SUBREGION, "Swamp Palace Prize"),
                  Some(|p| p.can_merge() && p.has_swamp_keys(4) && p.has_swamp_big_key() && p.can_defeat_arrgus()),
                  None,
                  None,
                  Some(|p| p.has_ice_rod() && (p.has_swamp_big_key() || p.has_tornado_rod())),
...
fn thieves_hideout() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (ThievesHideoutB2, location("Thieves' Hideout B2", vec![
            check_free(LocationInfo::new(regions::dungeons::thieves::hideout::SUBREGION, "[T'H] (B2) Grate Chest (Fall)")),
            ...
            check_free(LocationInfo::new(regions::dungeons::thieves::hideout::SUBREGION, "[T'H] (B2) Switch Puzzle Room")),
        ...
        (ThievesHideoutEscape, location("Thieves' Hideout Escape", vec![
            ...
            check_free(LocationInfo::new(regions::dungeons::thieves::hideout::SUBREGION, "[T'H] (B3) Big Chest (Hidden)")),
...
fn turtle_rock() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (TurtleRockPostBoss, location("Turtle Rock Boss", vec![
            check_free(LocationInfo::new(regions::dungeons::turtle::rock::SUBREGION, "[TR] Grinexx")),
            check_free(LocationInfo::new(regions::dungeons::turtle::rock::SUBREGION, "Turtle Rock Prize")),
        ], vec![])),
    ])
}
...
fn lorule_castle() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (LoruleCastle2F3F, location("Lorule Castle 2F 3F", vec![
            ...
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (3F) Bomb Trial (Chest)"),
                  Some(|p| p.has_bombs()),
                  None,
                  Some(|p| p.has_ice_rod()),
                  None,
            ...
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (3F) Bomb Trial (Behind Rock)"),
            ...
            check_free(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (3F) Ball Trial (Chest)")),
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (3F) Ball Trial (Puzzle)"),
                  Some(|p| p.can_merge()),
                  None,
                  None,
        ...
        (LoruleCastle4F5F, location("Lorule Castle 4F 5F", vec![
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (4F) Lamp Trial"),
                  Some(|p| p.has_fire_source()),
            ...
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (4F) Hookshot Trial (Eyes)"),
            ...
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (4F) Hookshot Trial (Chest)"),
                  Some(|p| p.has_hookshot()),
                  None,
                  None,
                  None,
            ...
            check_free(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (4F) Center")),
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] (4F) Hidden Path"),
                  Some(|p| p.can_extinguish_torches()),
                  Some(|_| true),
                  None,
                  None,
        ...
        (ThroneRoom, location("Throne Room", vec![
            check(LocationInfo::new(regions::dungeons::castle::lorule::SUBREGION, "[LC] Zelda"),
