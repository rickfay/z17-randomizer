...
fn dark_palace() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (DarkPalaceBoss, location("Dark Palace Boss", vec![
            check(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "[PD] Gemesaur King"),
            ...
            check(LocationInfo::new(regions::dungeons::dark::palace::SUBREGION, "Dark Palace Prize"),
                  Some(|p| p.can_defeat_gemesaur()),
                  None,
                  None,
                  None,
