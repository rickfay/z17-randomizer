...
fn hyrule() -> HashMap<Location, LocationNode> {
    HashMap::from([
        ...
        (HyruleField, location("Hyrule Field", vec![
            ...
            check(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "Hyrule Hotfoot (First Race)"),
                  Some(|p| p.has_boots()),
                  Some(|_| true),
                  None,
                  None,
            ...
            check(LocationInfo::new(regions::hyrule::lake::hylia::SUBREGION, "Hyrule Hotfoot (Second Race)"),
                  Some(|p| p.has_boots()),
